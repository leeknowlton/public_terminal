 ...
 */
export const APP_NAME: string = "Public_Terminal";

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = "Early internet chatroom text artifacts on-chain";
 ...
 */
export const APP_TAGS: string[] = ["chatroom", "text", "nft", "base", "artifact"];
 ...
 */
export const APP_BUTTON_TEXT: string = "TRANSMIT";
